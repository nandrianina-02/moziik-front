      ...
      <div className="flex flex-col gap-1">
        {(!playlist.musiques || playlist.musiques.length === 0)
          ...
          : playlist.musiques.map((song, index) => (
            <div key={song._id} className={`flex items-center justify-between p-3 rounded-xl cursor-pointer group transition ${currentSong?._id === song._id ? 'bg-purple-600/10' : 'hover:bg-white/5'}`}
              ...
              <div className="flex items-center gap-3 opacity-0 group-hover:opacity-100 transition">
                ...
                {isOwner && (
                  <button onClick={e => { e.stopPropagation(); removeFromPlaylist(song._id); }}>
